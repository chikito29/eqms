                    ...
                    <div class="col-md-12">
                        <div class="x-block">
                            <div class="x-block-head">
                                <h3>Revision Logs</h3>
                                <button class="btn btn-success pull-right @if(request('user.role') == 'document-controller') @else hidden @endif" onclick="add()"><span class="fa fa-user"></span>ADD</button>
                            </div>
                            <table class="table table-striped" id="table-application">
                                ...
                                <tr>
                                    ...
                                    <th>Revision no.</th>
                                    <th>Approved By</th>
                                    <th class="@if(request('user.role') == 'document-controller') @else hidden @endif" with="120">Actions</th>
                                </tr>
                                </thead>
                                <tbody>
                                    @foreach($logs as $log)
                                        <tr>
                                            ...
                                            <td class="@if(request('user.role') == 'document-controller') @else hidden @endif">
                                                <form class="form">
